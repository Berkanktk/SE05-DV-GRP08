...
#Here we manually setting up a grid of rows and columns within 
#a fluid page function. And within the fluid rows we can
#create multiple columns by adding those as arguments. 
#It's important to note here that the column width 
#which is set here by 4, should add up to 
#12 (here 3*4) units in each row.
